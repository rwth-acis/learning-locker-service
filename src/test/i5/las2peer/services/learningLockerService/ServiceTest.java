...
import i5.las2peer.services.learningLockerService.LearningLockerService;
...
public class ServiceTest {
		...
		public void startServer() throws Exception {
			...
			node.startService(new ServiceNameVersion(LearningLockerService.class.getName(), "1.0.0"), "a pass");
